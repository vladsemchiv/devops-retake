...
SVC_NAME="actions.runner.vladsemchiv-devops-retake.compute-vm-4-8-20-ssd-1774813134941.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (vladsemchiv-devops-retake.compute-vm-4-8-20-ssd-1774813134941)"
